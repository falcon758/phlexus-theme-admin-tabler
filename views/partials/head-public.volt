...
<link rel="icon" href="{{ url(publicUserThemePath ~ '/images/favicon/favicon.ico') }}"  type="image/x-icon">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,300i,400,400i,500,500i,600,600i,700,700i&amp;subset=latin-ext">
<link rel="stylesheet" href="{{ url(publicUserThemePath ~ '/css/dashboard.css') }}">
<link rel="stylesheet" href="{{ url(publicUserThemePath ~ '/css/theme-modern.css') }}">
<link rel="stylesheet" href="{{ url(publicUserThemePath ~ '/css/cookieconsent.min.css') }}">
